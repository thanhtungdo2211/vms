...
#   3. Re-add cam1 to branch recognition
#   4. Start streaming cam1 recognition to rtsp://152.42.221.89:8554/cam1_recognition
...
# Step 4: Start stream cam1 recognition
echo -e "\n[4] Starting stream cam1_recognition to $STREAM_URI..."
curl -s -X POST http://localhost:8083/api/cameras/cam1/branches/recognition/stream/start \
  -H "Content-Type: application/json" \
